...
export type BulkIdsRequest = components["schemas"]["BulkIdsRequest"];
export type AssetListFilters = components["schemas"]["AssetListFilters"];
export type AssetIdsResult = components["schemas"]["AssetIdsResult"];
